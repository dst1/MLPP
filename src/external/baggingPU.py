...
def _parallel_build_estimators(n_estimators, ensemble, X, y, sample_weight,
                               seeds, total_n_estimators, verbose, fit_params={}):
    ...
    for i in range(n_estimators):
        ...
        if support_sample_weight:
            ...
            estimator.fit(X[:, features], y, sample_weight=curr_sample_weight, **fit_params)

        # Draw samples, using a mask, and then fit
        else:
            estimator.fit((X[indices])[:, features], y[indices], **fit_params)
...
class BaseBaggingPU(with_metaclass(ABCMeta, BaseEnsemble)):
    ...
    def fit(self, X, y, sample_weight=None, fit_params={}):
        ...
        kargs : passed on to base classifier
        ...
        self : object
            Returns self.
        """
        return self._fit(X, y, self.max_samples, sample_weight=sample_weight, fit_params=fit_params)

    def _fit(self, X, y, max_samples=None, max_depth=None, sample_weight=None, fit_params={}):
        """Build a Bagging ensemble of estimators from the training
           set (X, y).
